...
router.get('/disponiveis', checkRole('motorista'), pedidosController.listarDisponiveis)
...
router.put('/:id/cancelar-aceitacao', checkRole('motorista'), pedidosController.cancelarAceitacao)
