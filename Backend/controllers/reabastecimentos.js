...
exports.create = async (req, res) => {
  try {
    ...
    // colisão com outros reabastecimentos do mesmo táxi
    ...
    if (taxi.tipo_motor === 'combustao') {
      ...
      // restrição 9 — todo o reabastecimento dentro do turno
    ...
    if (taxi.tipo_motor === 'eletrico') {
      ...
      // restrição 10 — só o início dentro do turno
    ...
    // restrição 26 — quilómetros crescentes
