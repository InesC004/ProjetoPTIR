...
### Relatório de Redes e Design

* `RelatorioRedes_design_grupo06.pdf`

Relatório referente à componente de **Redes e Design** do projeto, desenvolvido pelo Grupo 06.
...
│   └── RelatorioRedes_design_grupo06.pdf
│
└── Tecnologias_Informacao/
    ├── Relatorios_Reunioes/
    │   ├── Março-PTIR-2526-RELATÓRIO.pdf
    │   ├── Abril-PTIR-2526-RELATÓRIO.pdf
    │   ├── Maio-PTIR-2526-RELATÓRIO.pdf
    │   └── UltimaAvaliação-PTIR-2526-RELATÓRIO.DOCX.pdf
    │
    ├── Avaliacao/
    │   ├── Avaliador.pdf
    │   └── formularioAvaliador.pdf
    │
    └── Testes_Usabilidade/
